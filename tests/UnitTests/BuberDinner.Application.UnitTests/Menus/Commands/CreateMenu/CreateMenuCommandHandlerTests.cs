...
public class CreateMenuCommandHandlerTests
{
    ...
    public static IEnumerable<object[]> ValidCreateMenuCommands()
    {
        ...
        yield return new[]
        {
            CreateMenuCommandUtils.CreateCommand(sections: CreateMenuCommandUtils.CreateSectionCommand(sectionCount: 3)),
        };
        yield return new[]
        {
            CreateMenuCommandUtils.CreateCommand(CreateMenuCommandUtils.CreateSectionCommand(sectionCount:3,
