...
public sealed class Guest : AggregateRoot<GuestId>
{
    ...
    private readonly List<Rating> _ratins = new();
    ...
    private Guest(GuestId id, string firstName, string lastName, string profileImage, UserId userId) : base(id)
    {
        FirstName = firstName;
        LastName = lastName;
    ...
    {
        return new Guest(GuestId.CreateUnique(), firstName, lastName, profileImage, userId);
    }
}
